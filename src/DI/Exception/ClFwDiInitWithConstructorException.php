...
class ClFwDiInitWithConstructorException extends \ReflectionException implements ClFwExceptionInterface
{
    public function __construct(string $reflectionName, ?\ReflectionException $previous = null)
    {
        parent::__construct(
            message: sprintf(
                'Unable to instantiate class with dependencies with Reflection Name "%s"',
                $reflectionName
            ),
